...
def main():
    ...
    parser.add_argument('--reviewers', type=int, default=3, help='round number to be extracted')
    ...
    assign_reviewers(sdg_issues_year, arguments.round, arguments.reviewers)
